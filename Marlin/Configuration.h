 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.05, 80.24, 400, 175.00 } //174.88
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 300, 15 } //25
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 5, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -35, -0.85}
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (( X_BED_SIZE / 2 ) -50)  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (( Y_BED_SIZE / 2 ) -35)// (mm) Y point for Z homing
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { 4000, 4000, 1100 }
