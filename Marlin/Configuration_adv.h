...
#define HOMING_BUMP_MM { 2, 0, 0 }            // (linear=mm, rotational=°) Backoff from endstops after first bump
 ...
 */
#define SAFE_BED_LEVELING_START_X 50.0
#define SAFE_BED_LEVELING_START_Y 20.0
