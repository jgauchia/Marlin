...
#define HOMING_BUMP_MM      { 2, 5, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.11       // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define MESH_MIN_X (X_MIN_POS + 50)// MESH_INSET
  #define MESH_MIN_Y (Y_MIN_POS + 35)//MESH_INSET
  #define MESH_MAX_X X_MAX_POS //X_BED_SIZE - (MESH_INSET)
  #define MESH_MAX_Y Y_MAX_POS //Y_BED_SIZE - (MESH_INSET)
#endif
